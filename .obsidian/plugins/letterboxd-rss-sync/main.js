...
var LetterboxdPlugin = class extends import_obsidian.Plugin {
  async onload() {
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        (0, import_obsidian.requestUrl)(`https://letterboxd.com/${this.settings.username}/rss/`).then((res) => res.text).then(async (res) => {
          const parser = new import_fast_xml_parser.XMLParser();
          let jObj = parser.parse(res);
          const filename = (0, import_obsidian2.normalizePath)("/Letterboxd Diary.md");
          const diaryMdArr = jObj.rss.channel.item.sort((a, b) => a.pubDate.localeCompare(b.pubDate)).map((item) => {
...
var LetterboxdSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Letterboxd username").setDesc("The username to fetch data from. This account must be public.").addText((component) => {
